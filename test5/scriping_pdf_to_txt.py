...
with fitz.open('test5/pdf/sat-practice-test-5-answers.pdf') as file_answers:
    ...
    with open('test5/.txt/answers.txt', 'w', encoding='utf-8') as outfile_answers:
...
with fitz.open('test5/pdf/sat-practice-test-5.pdf') as file:
...
with open('test5/.txt/questions.txt', 'w', encoding='utf-8') as outfile:
