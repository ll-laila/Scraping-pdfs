...
with fitz.open('test3/pdf/sat-practice-test-3-answers.pdf') as file_answers:
    ...
    for page_num in range(num_pages):
        ...
        if  "Section 2: Writing and Language Test " in page_text :
            break
    ...
    with open('test3/.txt/answers.txt', 'w', encoding='utf-8') as outfile_answers:
...
with fitz.open('test3/pdf/sat-practice-test-3.pdf') as file:
...
with open('test3/.txt/questions.txt', 'w', encoding='utf-8') as outfile:
