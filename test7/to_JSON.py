...
with open('test7/json/questions.json', 'w') as questions_file:
...
with open('test7/json/choice.json', 'w') as choices_file:
...
with open('test7/json/answers.json', 'w') as answers_file:
