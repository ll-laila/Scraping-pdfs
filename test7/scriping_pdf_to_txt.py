...
with fitz.open('test7/pdf/sat-practice-test-7-answers.pdf') as file_answers:
    ...
    with open('test7/.txt/answers.txt', 'w', encoding='utf-8') as outfile_answers:
...
with fitz.open('test7/pdf/sat-practice-test-7.pdf') as file:
...
with open('test7/.txt/questions.txt', 'w', encoding='utf-8') as outfile:
