...
with fitz.open('test8/pdf/sat-practice-test-8-answers.pdf') as file_answers:
    ...
    with open('test8/.txt/answers.txt', 'w', encoding='utf-8') as outfile_answers:
...
with fitz.open('test8/pdf/sat-practice-test-8.pdf') as file:
...
with open('test8/.txt/questions.txt', 'w', encoding='utf-8') as outfile:
